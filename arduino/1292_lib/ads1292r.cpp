...
void ads1292r::ads1292_Init()
{
  ...
  delay(10);
  //! CONFIG2
  //0b10100011 for testing
  //0b10100000 for normal
  // ads1292_Reg_Write(ADS1292_REG_CONFIG2, 0b10100011);	//Lead-off comp off, test signal square wave disabled
  ads1292_Reg_Write(ADS1292_REG_CONFIG2, 0b10100000);	//Lead-off comp off, test signal square wave disabled
  delay(10);
  ads1292_Reg_Write(ADS1292_REG_LOFF, 0b00010000);		//Lead-off defaults
  delay(10);
  //modified turned off
  ads1292_Reg_Write(ADS1292_REG_CH1SET, 0b10010000);	//Ch 1 enabled, gain 6, connected to electrode in
  delay(10);
  //0b01100101 modified test signal
